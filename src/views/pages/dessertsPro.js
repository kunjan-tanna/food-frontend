...
import backImg from "../../imgs/dessert_bg.jpeg";
import dessertsItem from "../../imgs/Desserts.jpg";
//material-ui
...
const styles = {
   ...
   dessertsHeader: {
      backgroundImage: `url(${dessertsItem})`,
      backgroundRepeat: "no-repeat",
      backgroundSize: "cover",
   },
...
class DessertsPro extends React.Component {
   constructor(props) {
      super(props);
      this.state = {
         collapse: false,
      ...
      return (
         <Card style={styles.img}>
            ...
            >
               {/* dessertsHeader */}
               <Card>
                  <CardHeader style={styles.dessertsHeader}>

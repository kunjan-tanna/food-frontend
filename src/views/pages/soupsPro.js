...
import backImg from "../../imgs/soups_bg.jpeg";
import soupsItem from "../../imgs/soups.jpeg";
//material-ui
...
class SoupsPro extends React.Component {
   constructor(props) {
      super(props);
      this.state = {
         collapse: false,
      ...
      return (
         <Card style={styles.img}>
            ...
            >
               {/* Soups */}
               <Card>
                  <CardHeader style={styles.soupsHeader}>

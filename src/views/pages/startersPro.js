...
import backImg from "../../imgs/starters_bg.jpeg";
import pannerItem from "../../imgs/tandoorItem.jpg";
import chineseItem from "../../imgs/chineseItem.jpg";
//material-ui
...
class StartersPro extends React.Component {
   constructor(props) {
      super(props);
      this.state = {
         collapse: false,
      ...
      return (
         <Card style={styles.img}>
            ...
            >
               {/* Tandoor Starters */}
               <Card>
                  <CardHeader style={styles.tandoorHeader}>
                     ...
                     <Table responsive bordered style={styles.table}>
                        ...
                        {product.productDetails &&
                           product.productDetails.map((item, index) => {
                              if (item.categoryName == "Tandoor Starters") {
                                 return (
                                    <tbody key={index}>
                                       <tr>
               ...
               <Card>
                  ...
                  <CardBody>
                     <Table responsive bordered style={styles.table}>
                        ...
                        {product.productDetails &&
                           product.productDetails.map((item, index) => {
                              if (item.categoryName == "Chinese Starters") {
                                 return (
                                    <tbody key={index}>
                                       <tr>
                                          <td>{item.productName}</td>
